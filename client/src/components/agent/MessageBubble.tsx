...
function parseMessageContent(content: string) {
  ...
  return parts.map((part, i) => {
    ...
    // Strip any [CART_ADD:...] markers from visible text — they are parsed silently
    const visible = part.replace(/\[CART_ADD:[^\]]+\]/g, "").trim();
        ...
        <img
          ...
          onError={(e) => {
            (e.target as HTMLImageElement).src =
              `https://placehold.co/48x48/e8400c/ffffff?text=🍕`;
          }}
        />
      </div>
